  ...
  return (
    <div className='header-body'>
      <Navbar collapseOnSelect variant="dark" sticky="top">
        <Container>
        <Navbar.Brand as={Link} to='/' >Spotify Web App</Navbar.Brand>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" />
        <Navbar.Collapse id="responsive-navbar-nav" className='justify-content-lg-between'>
          <Nav className="me-auto">
            <Nav.Link as={Link} to='/PlaylistCreator'>Create Playlist</Nav.Link>
            <Nav.Link as={Link} to='/TopSongs'>Your Top Songs</Nav.Link>
            <Nav.Link as={Link} to='/FindSong'>Find Songs</Nav.Link>
          </Nav>
          <Nav>
